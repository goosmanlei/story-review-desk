...
export const modules={story,settings,materials,production,collaboration,project};
export function moduleFor(kind){const found=Object.entries(modules).find(([,m])=>m.kinds.includes(kind));check(found,'OBJECT_KIND','不支持的业务对象类型');return {name:found[0],...found[1]};}
