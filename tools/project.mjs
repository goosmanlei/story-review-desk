...
export async function createProject(
  ...
  const policy = {
    ...
    protectedPaths: [
      ...
      "review-software",
      "tasks",
      ".agents/skills/review-tasks",
      "instance/runtime/task-execution",
  ...
  const pkg = {
    ...
    scripts: {
      ...
      tasks: "node review-software/tools/tasks.mjs",
