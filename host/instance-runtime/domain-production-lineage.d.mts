...
export function domainProductionProofs(input:{candidates?:unknown[];requests?:unknown[];runs?:unknown[];versions:Map<string,unknown>}):Map<string,DomainProductionProof>;
