...
export function committedQueryJson(repository: InstanceRepository, queryKey: string,
  ...
  describe?: (metadata:Awaited<ReturnType<InstanceReadUnit['getMetadata']>>)=>void,
  metadataFor?:(tx:InstanceReadUnit)=>Promise<Awaited<ReturnType<InstanceReadUnit['getMetadata']>>>): Promise<string>;
