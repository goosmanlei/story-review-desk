...
export function preserveMaterialProductionProjection({snapshot,recipes,baseSnapshot,baseRecipes,documents}){
 ...
 const proof=materialProductionRebaseClosures({model:prior,recipes:baseRecipes,documents,initialClosures:closures,validateLegacySegment:materialProductionRevisionClosures});
