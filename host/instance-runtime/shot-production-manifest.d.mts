...
export function previewShotProductionManifest(tx:unknown,input:{workItemId:string;api?:unknown;model?:unknown;state?:unknown}):Promise<Record<string,unknown>>;
