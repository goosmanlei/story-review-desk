...
export function loadMaterialUsageEvidence<T extends object>(tx:InstanceReadUnit,model:T,options?:{view?:Awaited<ReturnType<InstanceReadUnit['readView']>>}):Promise<T&{materialUsageEvidence?:MaterialUsageEvidence[]}>;
