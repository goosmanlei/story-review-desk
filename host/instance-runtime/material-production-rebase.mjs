...
export async function readMaterialProductionRebaseAnchor(tx,{model,recipes,plan}){
 ...
 const proof=materialProductionRebaseClosures({model:{...model,materialProductionPlans:[plan],materialProductionRecipeRevisions:rows},recipes,documents,initialClosures:[{plan,...initial}],validateLegacySegment:materialProductionLegacyRevisionClosures,instanceId:(await tx.getMetadata()).instanceId});
