...
export type ShotDesignRequirementSemanticBinding={requirementId:string;requirementSemanticHash:string;acceptanceCriteria:unknown[];authority:unknown;requirement:Record<string,unknown>;demand:Record<string,unknown>|null;conditions:Record<string,unknown>;directoryOwnership:Record<string,unknown>|null;graphClosure:Record<string,unknown>};
