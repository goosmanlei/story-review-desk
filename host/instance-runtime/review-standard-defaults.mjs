...
const production={
 ...
 EPISODE_TECH_QC_REPORT:[['picture-technical','画面规格','画幅、尺寸、帧率、编码和色彩是否符合已确认发行规格？'],['audio-technical','声音规格','声道、采样、响度和峰值是否符合已确认发行规格？'],['playback','播放与同步','完整文件是否可正常解码播放，音画及字幕是否同步？'],['report-evidence','检查证据','报告是否对应实际交付文件，并清楚记录检查结果和未解决问题？']],
