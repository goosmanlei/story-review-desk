 ...
 * equal the first-setup closure or have a separately verified current bridge. */
export async function resolveMaterialProductionRequirement(tx,{model,plan,requirement,family,work,demand,representation}){
