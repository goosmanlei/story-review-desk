...
export type ShotDesignPlan={canAuthor:boolean;materialRequirementSetSchemaVersion?:'2.0'|'3.0';basisBindings:Binding[];candidate?:{creativeRevisionId:string;content:Content};template?:{planId:string;revisionHash:string;content?:Content;retiredShotIds?:string[]}};
