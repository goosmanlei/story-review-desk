...
export const commentTargetBinding = (target: StoryCommentTarget) => ({kind:target.kind,subjectId:target.subjectId,revisionId:target.revisionId,planContentHash:target.planContentHash,contentHash:target.contentHash,contextHash:target.contextHash});
