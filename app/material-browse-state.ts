...
const fields=['entity','materialEntityType','materialMedia','materialPrimary','materialCategory','materialEpisode','materialScene','materialCreatorStage','materialCoverage','materialQ'] as const;
...
export function restoreMaterialBrowseLocation(url:URL,force=false) {
  ...
  if(!force&&[...fields,'materialPanel','material','family','version','asset','materialState','materialRelation','materialTrial','materialTrialVersion','materialDefinitionId','materialDefinitionKind','materialDefinitionTab','materialRepresentation'].some(field=>url.searchParams.has(field)))return false;
  ...
  for(const field of ['material','family','version','asset','materialState','materialRelation','materialTrial','materialTrialVersion','materialDefinitionId','materialDefinitionKind','materialRepresentation'])url.searchParams.delete(field);
