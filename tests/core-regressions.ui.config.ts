...
export default defineConfig({
  testDir:'.',
  testMatch:["empty-instance.ui.spec.ts","story-settings.ui.spec.ts","free-canvas.ui.spec.ts","optimization-components.ui.spec.ts","closed-comment-history.ui.spec.ts","material-entity-review.ui.spec.ts","canvas-geometry.ui.spec.ts","system-management.ui.spec.ts","configuration-layout.ui.spec.ts","entity-workflow.ui.spec.ts","workflow-review-feedback.ui.spec.ts","pipeline-preparation-entry.ui.spec.ts","preparation-four-stage.ui.spec.ts","narrative-unified.ui.spec.ts","narrative-reading.spec.tsx","narrative-six-groups.spec.tsx"],
