...
export async function apiFixture(t){
 ...
 return {...f,store,material,adapter,materialPost,workspace,saveBody,provision,beginRun,register,review,evidence,post,requests,runs,versions,reviews,externalCalls:()=>externalCalls};
}
