...
const query=await load(emitted('../app/api/v8/ui/_material-query.ts',['materialDirectoryProjection','materialUsagePageBindings','summarizeMaterialPage']),{currentMaterialRequirementRows,projectMaterialRequirementDispositions,objectSummary});
