...
export type AssistantResource = {
  ...
  bodyBinding?: import('../../presentation/assistant-source.mjs').BodyBinding;
  relationBinding?: import('../../presentation/assistant-source.mjs').BodyBinding;
  bodySection?: 'TEXT'|'RELATIONS';
  bodyRange?: {byteStart:number;byteEnd:number};
  bodyOf?: string;
  sourceBinding?: import('../../presentation/assistant-source.mjs').SourceBinding;
};
