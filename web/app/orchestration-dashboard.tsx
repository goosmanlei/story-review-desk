...
import type {DashboardTask, OrchestrationDashboard as Dashboard} from '../presentation/orchestration-dashboard.mjs';
...
export function OrchestrationDashboard() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      const response = await fetch(`/api/v1/workspaces/orchestration?completedPage=${page}`,{method:'GET',cache:'no-store',signal:controller.signal});
