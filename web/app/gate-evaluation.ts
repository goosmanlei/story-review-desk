import {materialRequirementSelectionReasons} from '../presentation/material-requirement-disposition.mjs';
import {executionRuntimeReason,type ExecutionRuntime} from '../presentation/execution-epoch.mjs';
import {domainReferenceEligibility} from '../presentation/domain-reference.mjs';
import {shotProductionInputConsumptionReasons,shotProductionProjectedConsumptionReasons} from '../presentation/shot-production-stage-policy.mjs';
